...
class LabelStudioApi:
    ...
    def create_project(
        ...
        if not label_config:
            data['label_config'] = self.get_init_label_config(import_json)
...
if __name__ == '__main__':
    ...
    # 导出标注json文件
    # label_studio_api.export_annotations(
    #     397, output_dir='/home/youjiachen/workspace/ELLM_V3.0/本期/long'
    # )
    json_input = '/home/youjiachen/workspace/code/v3test_json.json'
    # label_studio_api.create_project('ellmv3.0-51场景', import_json=json_input)
    # label_studio_api.import_tasks(408, import_json=json_input)
    # label_studio_api.upload_recog(295)
    # label_studio_api.import_tasks(402, import_json='/home/youjiachen/workspace/ELLM_V3.0/往期/short/智能结构化第二批 #房产证数据-final.json')
    label_studio_api.export_annotations(408, output_dir='./')